...
products_df.rename(columns={
    ...
    'Unit Price USD': 'UnitPriceUSD'  # Use 'Price' if 'UnitPriceUSD' does not exist
}, inplace=True)
...
products_columns = ['ProductKey', 'ProductName', 'Category', 'UnitPriceUSD']  # Use 'Price' if 'UnitPriceUSD' does not exist
